<?php
    ...
    $sql = "select * from tbl_ot_request WHERE ot_re_department LIKE '$id%' ORDER BY ot_re_date DESC";
    $result = mysqli_query($link,$sql);
    $line = 25;
    ...
    if($dbarr=mysqli_fetch_array($result)){
    $pdf->SetFont('bold','',18);
    ...
    $pdf->SetFont('bold','',18);
    $pdf->cell(265,10,iconv( 'UTF-8','TIS-620','(......................................)'),0,1,"R");
    $pdf->Cell(15,15,iconv( 'UTF-8','TIS-620',$dbarr['ot_re_price']),1,1,"L");
    }
